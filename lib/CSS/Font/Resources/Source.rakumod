...
my constant %Extensions = %( :woff<woff>, :woff2<woff2>, 'ttf'|'ttc' => 'truetype', :otf<opentype>, :eot<embedded-opentype>, 'svg'|'svg2' => 'svg', 'pfa'|'pdf' => 'postscript', 'cff' => 'cff');
...
sub guess-format(Str:D() $_ --> FontFormat) is export(:guess-format) {
    do if $_ ~~ /'.'(<- [.]>+?) $/ {
        %Extensions{$0.lc};
    } // Str
}
